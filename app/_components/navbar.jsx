...
const Navbar = () => {
  ...
  return (
    <div className='fixed bottom-5 items-center md:w-fit w-5/6 px-6 py-2 flex md:gap-28 mx-auto left-1/2 -translate-x-1/2 bg-white/5 rounded-xl border backdrop-blur-md text-black md:justify-center justify-between font-semibold z-20'>
